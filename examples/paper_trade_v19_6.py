...
# v19.6-shadow (since 2026-05-27 v19.10 production upgrade): 独立 state/log,
# 跟主 production v19.10 平行跑 daily_check. forward 12 月 A/B 真实对比.
STATE_PATH = ROOT / "data_cache" / "portfolio_state_v19_6.json"
LOG_PATH = ROOT / "data_cache" / "paper_trade_log_v19_6.csv"
PICKS_PATH = ROOT / "data_cache" / "picks_today_v19_6.json"  # shadow 独立, 防覆盖 production picks_today.json
...
def main(dry_run: bool = False):
    ...
    try:
        if USE_V19_6_SIDECAR and overlay_meta.get("sidecar_applied"):
