"""补 4 个 CSI300 缺失科创板股票 baidu_kline 数据 (688303 / 688396 / 688506 / 688981).

复用 fetch_corrupt_fix_v3_extended.py 的 腾讯 hfq 拉取逻辑。
输出到 data_cache/baidu_kline_688_csi300.parquet, 后续手动 merge 到 baidu_kline.parquet。
"""
...
OUT_PARQUET = ROOT / "data_cache" / "baidu_kline_688_csi300.parquet"

MISSING_CODES = ["688303", "688396", "688506", "688981"]
